...
export const hobbyContents: HistoryObject[] = [
  {
    ...
    subTitle: "메이플스토리",
    description:
      "17년도부터 꾸준히 즐기는 게임이다. 이 밖에도 경뿌나 이벤트 버프를 제때 받기 위해서, 채팅으로 설정한 시간마다 디스코드 채널에 알림을 보내는 디스코드 봇을 만들어 heroku에 배포해서 같이 게임을 즐기는 길드원들과 같이 사용해봤다. 이후에 추첨 뽑기 같은 기능도 추가하여 사용했다.",
    links: [
      {
  ...
  },
  {
    ...
    description:
      "유성구 종합사회복지관 수영장에서 고등학교 친구와 초급반 수업을 듣고 있다. 분명 초급반인데.. 2주도 안되어서 자유형 배형을 배우고 있다. 수영을 통해 몸을 건강하게 유지하고, 친구와 함께, 즐거운 시간을 보내고 있다. ",
    links: [
      {
