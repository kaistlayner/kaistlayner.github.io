...
export const memorableLectures: HistoryObject[] = [
  ...
  },
  {
    ...
    description:
      "OpenGL을 통해 3D 그래픽스를 구현하였습니다. 수업을 통해 3D 그래픽스의 기본적인 개념을 이해하고, 주어진 skeleton 코드를 통해서 3D cow를 키보드 마우스와 연결해서 확대하고 회전시키는 등의 구현을 했고, 빛과 카메라의 위치에 의한 빛 반사와 그림자를 최대한 자연스럽게 구현했습니다. 이를 통해 3D 그래픽스의 기본적인 개념을 이해하게 되었습니다.",
  },
];
...
export const hobbyContents: HistoryObject[] = [
  {
    ...
    subTitle: "메이플스토리",
    description:
      "17년도부터 꾸준히 즐기는 게임입니다. 이 밖에도 경뿌나 이벤트 버프를 제때 받기 위해서, 채팅으로 설정한 시간마다 디스코드 채널에 알림을 보내는 디스코드 봇을 만들어 heroku에 배포해서 같이 게임을 즐기는 길드원들과 같이 사용해봤습니다. 이후에 추첨 뽑기 같은 기능도 추가하여 사용했습니다.",
    links: [
      {
